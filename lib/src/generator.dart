...
class UsernameGen implements UsernameGenImpl {
  ...
  @override
  setAdjectives(_adjectives) {
    data.adjectives = _adjectives;
  }

  @override
  setSeperator(new_seperator) {
  ...
  static gen({UsernameGenData? data, String seperator = '-'}) {
    data ??= UsernameGenData(names: names, adjectives: adjectives);
